...
import { FileText, Fingerprint, Loader2, Mail, Phone, UserIcon } from "lucide-react";
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-semibold text-gray-900">{Agente.usuario.nome}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                <p className="text-sm font-medium text-gray-500">Número de Matrícula</p>
                                <p className="text-lg font-semibold text-gray-900">{Agente.matricula}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-semibold text-gray-900">{Agente.usuario.telefone}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-semibold text-gray-900">{Agente.usuario.cpf}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-lg font-semibold text-gray-900">{Agente.usuario.email}</p>
                            </div>
                        </div>
                    </div>
