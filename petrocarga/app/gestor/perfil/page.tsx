                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-semibold text-gray-900">{gestor.nome}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-semibold text-gray-900">{gestor.telefone}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-semibold text-gray-900">{gestor.cpf}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-lg font-semibold text-gray-900">{gestor.email}</p>
                            </div>
                        </div>
                    </div>
