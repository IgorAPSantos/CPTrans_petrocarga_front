    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
            ...
            {[
              {
                ...
                description: "Reserve seu horário de forma rápida e descomplicada"
              },
              {
                icon: CheckCircle,
      ...
      <section className="bg-white py-8 md:py-16">
        <div className="container mx-auto px-4">
          <div className="w-full max-w-5xl mx-auto">
            <h2 className="text-xl md:text-3xl font-bold text-center mb-8 md:mb-12">Como Funciona a Reserva</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              {[
                ...
                <div key={index} className="text-center p-3 md:p-4">
                  ...
                  <h3 className="font-semibold text-sm md:text-lg mb-2">{item.title}</h3>
                  <p className="text-xs md:text-sm text-gray-600">{item.description}</p>
                </div>
              ))}
            </div>
